...
const default_prompts = {
    "Quick start advice": {
      "prompt": "The best way to learn how to use this extension is to read, edit, and run some of the preloaded prompt templates. You can start down this road by clicking the \"Templates & Settings\" button at the bottom of this window.",
      "model": "gpt-3.5-turbo",
      "temperature": 0.7,
      "max_tokens": 250,
      "output": 0,
    ...
    "Define selected word/phrase": {
      "prompt": "Define the following word/phrase: {{highlighted}}\n\n",
      "model": "gpt-3.5-turbo",
      "temperature": 0,
      "max_tokens": 250,
      "output": 1,
